...
public abstract class ScreenBeta implements Screen, InputProcessor {
    ...
    ScreenBeta()
    {
       ...
       // tableContainer.setDebug(true);
        ...
        buttonStyle = new ButtonStyle(skin.getDrawable("button-c"), skin.getDrawable("button-pressed-c"), skin.getDrawable("button-over-c"));

        //INITIALIZE A LABEL
        labelStyle = new LabelStyle(skin.get(("default"), Label.LabelStyle.class));
